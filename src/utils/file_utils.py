...
def validate_file_size(file_path: str, max_size_mb: Optional[float] = None) -> Tuple[bool, float, Optional[str]]:
    """
    ...
    try:
        ...
        if max_size_mb is not None and file_size_mb > max_size_mb:
            error_msg = f"File too large: {file_size_mb:.2f}MB exceeds limit of {max_size_mb}MB"
